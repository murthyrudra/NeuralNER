...
def main():
	...
	network = BiCNNLSTMTranstionOutput(inputVocabulary.__len__(), embeddingDimension, min_filter_width, max_filter_width, charVocabulary.__len__(), num_filters, hidden_size, targetVocabulary.__len__() , word_embedding, args.beta, targetVocabularyAux.__len__())
